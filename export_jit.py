...
def get_args():
    ...
    parser.add_argument('--output_file', default='wenet.pt', help='output file')
...
def main():
    ...
    if args.output_file:
        ...
        a = torch.randn([1, 498, 80])
        a_lens = torch.as_tensor([a.shape[1]])
        beam_size=10,
        decoding_chunk_size=-1,
        num_decoding_left_chunks=-1,
        simulate_streaming=True
        script_model = torch.jit.trace(model, (a, a_lens))
